...
function InSospesoDetails({ match }) {
        ...
        <div className="containerFluid">
            <div className="row">
                ...
                <div className="col-md-4 searchitem-card">
                    ...
                    <button className="btn-gradient btn-dashboard">Conferma</button>    
                    <button className="btn-secondary btn-dashboard" style={{borderRadius: 3 +'em'}}>Rifiuta</button>    
                </div>
...
export default InSospesoDetails;
